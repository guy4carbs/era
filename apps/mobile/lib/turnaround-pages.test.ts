/**
 * Unit tests for the pure turnaround page-order composition. Plain Node
 * (`node --experimental-strip-types --test`), no device, no React — the composer
 * is data-in/data-out by design. Coverage:
 ...
 *
 * Run: node --experimental-strip-types --test apps/mobile/lib/turnaround-pages.test.ts
 */
