...
## In-flow checkout (Era Checkout)

Era Checkout lets you buy pieces from more than one store in a single checkout, without leaving Era. It is **optional**, works **only with retailers we've verified one at a time**, and is **off by default** — you choose when to use it, and for retailers we don't support you tap out to the store the same way you always have. Here's how it handles your data.

- **What it is.** You add items from different stores to one cart and check out once inside Era. Behind the scenes each store still sells and ships its own order, so you'll receive **separate shipments and separate receipts** per store — Era only coordinates the single checkout.
- **What we store.** Your **cart** (the items you've added and their quantities), any **sizes you've saved**, and **one shipping address** you enter for delivery. You can edit or delete your saved address at any time in **Settings**, and it — along with your cart — is removed when you delete your account.
- **What goes to our checkout partner, per order.** To place an order, Era sends our checkout partner (Rye) the details it needs to buy on your behalf: your **name, shipping address, email address, phone number**, and the **product and quantity** you're ordering. We **never** send a card number — see payment, below.
- **Payment is tokenized.** Era never sees or stores your card number. Your payment is handled as a secure token by the checkout partner and the retailer; Era only learns whether the order went through. *(In our current sandbox, only test payment tokens are used — no real card is ever charged.)*
- **Order records we keep.** For each order you place we keep a record so you can see your history and we can help you if something goes wrong: **what you ordered, the totals, and the order status** (for example, placed, confirmed, shipped, or failed). This record is tied to your account and is deleted when you delete your account.
- **Commissions.** When you buy through Era Checkout, Era may **earn a commission** on eligible orders, at no extra cost to you — routed to us by the checkout partner through affiliate networks. As with the rest of Shop, **commissions never affect how Ovi ranks or suggests anything** (see our [Terms](/terms#7-third-party-links-brands-and-shopping) for the full disclosure).
- **Deleting it.** Your cart, saved sizes, saved shipping address, and order records are tied to your account and are **removed when you delete your account** (**Settings → Delete account**); you can also clear your cart or delete your saved address on their own in **Settings** at any time. The retailer and the checkout partner keep their own records of any order you actually placed, under their policies and as the law requires (for example, for fulfillment, returns, and tax) — that history is not ours to delete.
...
- **Checkout partner (Rye)** — when in-flow checkout (Era Checkout) is enabled, to place your cross-store orders with the retailers on your behalf. We send only the order details needed to buy — your name, shipping address, email, phone, and the product and quantity — never a card number, since payment is tokenized. Era may earn a commission on eligible orders that the partner routes to us through affiliate networks. *(Currently dormant until the feature is enabled.)*
...
- **Cart, saved sizes, saved shipping address, and order records (Era Checkout)** — kept while your account is active; your cart and saved address can be cleared or edited on their own in Settings, and all of it is deleted when you delete your account. The checkout partner and the retailers keep their own records of any order you placed under their policies and as the law requires; that history is not ours to delete.
